 ...
 */
class SimpleNthIterator<E> implements java.util.Iterator<E> {
    /** Reference to currently considered element within list */
    protected SimpleListNode<E> current;
    protected int nth;
    ...
    @param t The first element of list to be traversed.
     */
    public SimpleNthIterator(SimpleListNode<E> t, int n) {
        current = t;
        nth = n;
    }
...
public class SimpleLinkedList<E> implements Iterable<E> {
    ...
    {
        return new SimpleNthIterator<E>(head, n);
    }
    ...
    {
        SimpleLinkedList<String> firstList = new SimpleLinkedList<String>();
        SimpleLinkedList<Integer> secondList = new SimpleLinkedList<Integer>();
        
        firstList.add("choice");
        firstList.add("chicken");
        firstList.add("chops");
        firstList.add("chipper");
        firstList.add("chopper");
        ...
        Iterator<String> iter = firstList.everyNthIterator(2);
        while(iter.hasNext())
        {
            System.out.println(iter.next());
        }
        
        Iterator<Integer> iter2 = secondList.everyNthIterator(3);
        while(iter2.hasNext())
        {
